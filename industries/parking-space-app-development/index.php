    ...
    <section class="stripe">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="image-wrap">
                        <img src="/thescrapps-revamp/assets/img/mix/park-1.png" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-6">
                    <div class="image-wrap">
                        <img src="/thescrapps-revamp/assets/img/mix/park-2.png" alt="">
                    </div>
                </div>
            </div>
        </div>
				...
				<div class="row align-items-center justify-content-between">
					...
					<div class="col-lg-4">
						<div class="project-img" data-aos="zoom-out-left">
							<img src="/thescrapps-revamp/assets/img/mix/park-cta1.png" alt="">
						</div>
					</div>
				</div>
			</div>
