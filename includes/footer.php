<footer class="footer aos-anim mt-0">
				...
				<div class="row">
					<div class="col-lg-3">
						<div class="logo-widget">
							...
							<ul class="social-link">
								<li><a href="javascript:;" target="_blank"><i class="ic-11"></i></a></li>
								<li><a href="javascript:;" target="_blank"><i class="ic-12"></i></a></li>
								<li><a href="javascript:;" target="_blank"><i class="ic-13"></i></a></li>
					...
					<div class="col-lg-3">
						<div class="link-widget">
							<h5>Quick Links</h5>
							<ul>
								<li><a href="/thescrapps-revamp/about-us/ ">About</a></li>
								<li><a href="/thescrapps-revamp/portfolio/ ">Portfolio</a></li>
								<!-- <li><a href="/partners/">Blog</a></li> -->
								<li><a href="/thescrapps-revamp/contact-us/ ">Contact</a></li>
							</ul>
	...
	<div class="sec-copyright">
		<div class="container">
			<div class="fflex">
				<p>Copyright &copy <span class="copyrightyear"></span> <strong><?php echo "$brandName";?></strong>. All Rights Reserved.</p>
